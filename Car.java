...
public class Car {
	 ...
	 * 
	 */
	public Car(roadSquare goalsq, int initspeed, float vision, Random rand){
		goal = goalsq;
		speed = initspeed;
		visibility = vision;
		random = rand;
	 ...
	 * 
	 * @param roadSquare location - the car's current location
	 ...
	 */
	public int getAction(roadSquare location, ArrayList<roadSquare> neighbors){
